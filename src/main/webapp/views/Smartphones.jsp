                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href='<s:url namespace="/" action="addSp"/>'> Ajouter un nouveau produit</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Image</th>
                                ...
                                <s:iterator value="listSp">
	                                <tr>
	                                    <td><img src="<s:property value="pic1"/>" alt="" /></td>
	                                    <td><s:property value="marque"/> <s:property value="model"/></td>
	                                    <td>
	                                    ...
	                                    <s:url namespace="/" action="addSp" var="lienAddSp"/>
	                                    ...
	                                    <td>
	                                    	<s:a href="%{lienAboutSp}" style="color: white;">
	                                    		<button data-toggle="tooltip" title="Détails" class="btn btn-primary"><i class="fa fa-wrench" aria-hidden="true"></i></button>
	                                    	</s:a>
   			...
   			<div class="as-notif-banner">
	        	<div class="as-notif-icon">
	            	...
	            	<div class="as-notif-message">
	            		<s:property value="marque"/> <s:property value="model"/> ajouté!
	            	</div>
	        	</div>
	    	</div>
	   	</s:if>
	   	<s:elseif test="%{spIsUpdated == true}">
	    	<div class="as-notif-banner">
	        	<div class="as-notif-icon">
	            	<div class=" as-success-notif">
	                	<div class="as-circle"></div>
	            	...
	            	<div class="as-notif-message">
	            		<s:property value="marque"/> <s:property value="model"/> modifié!
	            	</div>
	        	</div>
	    	</div>
	    </s:elseif>
	    <s:elseif test="%{spIsDeleted == true}">
	    	<div class="as-notif-banner">
	        	<div class="as-notif-icon">
	            	<div class=" as-success-notif">
	                	<div class="as-circle"></div>
	            	...
	            	<div class="as-notif-message">
	            		<s:property value="marque"/> <s:property value="model"/> supprimé!
	            	</div>
	        	</div>
	    	</div>
	    </s:elseif>
