                                ...
                                <ul id="myTab3" class="tab-review-design">
	                                ...
	                                <form action="saveClient.action" method="post">
	                                    <div class="product-tab-list tab-pane fade active in" id="description">
	                                            ...
	                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                                                <div class="review-content-section">
	                                                    <div class="input-group mg-b-pro-edt">
	                                                        ...
	                                                        <input type="text" name='nom' class="form-control" placeholder="Nom" value='<s:property value="client.nom"/>'>
	                                                    </div>
	                                                    <div class="input-group mg-b-pro-edt">
	                                                        <span class="input-group-addon"><i class="fa fa-tasks" aria-hidden="true"></i></span>
	                                                        <input type="text" name="prenom" class="form-control" placeholder="Prénom"  value='<s:property value="client.prenom"/>'>
	                                                    </div>
	                                                    <div class="input-group mg-b-pro-edt" style="color: white;">
	                                                        
                                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                            <div class="i-checks pull-left">
                                                                                <label>
																						<input type="radio" 
																						<s:if test="%{client.sexe == 'M'}">
																							checked
																						</s:if>
																						value="M" name="sexe"> <i></i> Masculin </label>
                                                                            </div>
                                                                            <div class="i-checks pull-left" style="margin-left: 50px;">
                                                                                <label>
																						<input type="radio" 
																						<s:elseif test="%{client.sexe == 'F'}">
																							checked
																						</s:elseif>
																						 value="F" name="sexe"> <i></i> Féminin </label>
                                                                            </div>
                                                                        </div>
	                                            ...
	                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                                                <div class="review-content-section">
	                                                	...
	                                                	<div class="input-group mg-b-pro-edt">
	                                                        ...
	                                                        <input type="text" name="cin" class="form-control" placeholder="CIN" value='<s:property value="client.CIN"/>'/>
	                                                    </div>
	                                                    <div class="input-group mg-b-pro-edt">
	                                                        <span class="input-group-addon"><i class="fa fa-camera" aria-hidden="true"></i>
	                                                        </span>
	                                                        <input type="text" name="adresse" class="form-control" placeholder="Adresse" value='<s:property value="client.adresse"/>'/>
	                                                    </div>
	                                                     <div class="input-group mg-b-pro-edt">
	                                                        <span class="input-group-addon"><i class="fa fa-camera-retro" aria-hidden="true"></i>
	                                                         </span>
	                                                        <input type="text" name="ville" class="form-control" placeholder="Ville" value='<s:property value="client.ville"/>' />
	                                                    </div>
	                                        ...
	                                        <s:hidden name="idClient" value="%{idClient}"></s:hidden>
	                                        <div class="row">
	                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                                <div class="text-center custom-pro-edt-ds">
	                                                    ...
	                                                    <a  href='<s:url action="client"/>' class="btn btn-danger">Annuler</a>
	                                                </div>
	                                            </div>
	                                        </div>
	                                    </div>
