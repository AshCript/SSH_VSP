                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
	                                ...
	                                <form action="saveCmd.action" method="post">
	                                        ...
	                                        <div class="row">
	                                                ...
	                                                <div class="review-content-section">
	                                                   ...
	                                                   <br/>
	                                                    ...
	                                                    <div class="chosen-select-single mg-b-20">
			                                                <select name="idClient" class="select2_demo_3 form-control">
																	<option>Sélectionnez un client</option>
			                                                		<s:iterator value="listClients">
																		<option value='<s:property value="idClient"/>'
																			<s:if test="%{idClient == commande.client.idClient}">
																				selected 
																			</s:if>
																		><s:property value="idClient"/>. <s:property value="nom"/> <s:property value="prenom"/></option>
																	</s:iterator>
																</select>
			                                            </div>
			                                            ...
			                                            <div class="chosen-select-single mg-b-20">
			                                                <select name="idSmartphone" class="select2_demo_3 form-control">
																<option>Sélectionnez un produit <s:property value="commande.idSmartphone"/></option>
																	<s:iterator value="listSmartphones">
																		<option value="<s:property value="idSmartphone"/>" 
																			<s:if test="%{idSmartphone == commande.smartphone.idSmartphone}">
																				selected 
																			</s:if>
																			onclick="changePrix('<s:property value="prixMGA"/>');"><s:property value="marque"/> <s:property value="model"/></option>
																	</s:iterator>
															</select>
			                                            </div>
	                                                 </div>
	                                            ...
	                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                                                <div class="review-content-section">
	                                    				...
	                                    				<div class="chosen-select-single mg-b-20">
			                                                <select name="color" class="select2_demo_3 form-control">
			                                                		<option>
																		Couleur
																	</option>
																	<option value="Noir"
																		<s:if test="%{commande.smartphone.color == 'Bleu'}">
																			 selected
																		</s:if>
																		>Noir
																	</option>
																	<option value="Bleu"
																		<s:if test="%{commande.color == 'Bleu'}">
																			 selected
																		</s:if>
																		>Bleu
																	</option>
																	<option value="Blanc"
																		<s:if test="%{commande.color == 'Blanc'}">
																			 selected
																		</s:if>
																		>Blanc
																	</option>
																	<option value="Rose"
																		<s:if test="%{commande.color == 'Rose'}">
																			 selected
																		</s:if>
																		>Rose
																	</option>
																	<option value="Gold"
																		<s:if test="%{commande.color == 'Gold'}">
																			 selected
																		</s:if>
																		>Gold
																	</option>
																	<option value="Rouge"
																		<s:if test="%{commande.color == 'Rouge'}">
																			 selected
																		</s:if>
																		>Rouge
																	</option>
																	<option value="Gris sidéral"
																		<s:if test="%{commande.color == 'Gros sidéral'}">
																			 selected
																		</s:if>
																		>Gris sidéral
																	</option>
	                                                    ...
	                                                    <div class="input-group mg-b-pro-edt">
	                                                        ...
	                                                        <input id="qte" type="text" name="quantite" class="form-control" placeholder="Quantité" onchange="changeMontant();" value='<s:property value="commande.quantite"/>'/>
	                                                    </div>
	                                                     <div class="input-group mg-b-pro-edt">
	                                                        <span class="input-group-addon"><i class="fa fa-camera-retro" aria-hidden="true"></i>
	                                                         </span>
	                                                        <span id="prixSP" class="form-control" placeholder="Prix"  style="text-align: right;" 
	                                                        <s:if test="%{editMode == true}">
	                                                        	value = "<s:property value='commande.prixMGA'/>"
	                                                        </s:if>
	                                                         ><s:property value='commande.prixMGA'/> Ar.</span>
	                                                    </div>
	                                                    <div class="input-group mg-b-pro-edt">
	                                                    	<span class="input-group-addon"><i class="fa fa-camera-retro" aria-hidden="true"></i>
	                                                         </span>
	                                                          <span id="montant" type="text" name="total" class="form-control" placeholder="Montant Total"  style=" text-align: right" >Total : <s:property value="commande.prixMGA*commande.quantite"/> Ar.</span>
	                                                    </div>
	                                                    <input type="text" id="xprixSP" name="prixMGA" value='<s:property value="commande.prixMGA"/>' hidden/>
		                                                  <script type="text/javascript">
			                                            	function changePrix(x){
			                                            		var txt ="" + x;
	                                        ...
	                                        <div class="row">
	                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                                                <div class="text-center custom-pro-edt-ds">
	                                                    ...
	                                                    <a  href='<s:url action="cmd"/>' class="btn btn-danger">Annuler</a>
	                                                </div>
	                                            </div>
	                                        </div>
	                                    </div>
