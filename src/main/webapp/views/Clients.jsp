                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href='<s:url namespace="/" action="addClient"/>'> Ajouter un nouveau client</a>
                            </div>
                            <table>
                                <tr>
                                    <th>ID</th>
  	...
  	<!-- Fenêtre de dialogue -->
   	<div class="asWindow container">
	    ...
	    <s:if test="%{clientIsAdded == true}">
	   	...
	   	<s:elseif test="%{clientIsUpdated == true}">
	    	<div class="as-notif-banner">
	        	<div class="as-notif-icon">
	            	<div class=" as-success-notif">
	                	<div class="as-circle"></div>
	    ...
	    <s:elseif test="%{clientIsDeleted == true}">
	    	<div class="as-notif-banner">
	        	<div class="as-notif-icon">
	            	<div class=" as-success-notif">
	                	<div class="as-circle"></div>
