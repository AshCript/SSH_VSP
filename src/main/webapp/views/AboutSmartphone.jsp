								...
								<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
									<div id="myTabContent1" class="tab-content">
										<div class="product-tab-list tab-pane fade active in" id="single-tab1">
											<img src='<s:property value="smartphone.pic1"/>' alt="" class="asBigPic"/>
										</div>
										<div class="product-tab-list tab-pane fade" id="single-tab2">
											<img src='<s:property value="smartphone.pic2"/>'  alt="" class="asBigPic"/>
										</div>
										<div class="product-tab-list tab-pane fade" id="single-tab3">
											<img src='<s:property value="smartphone.pic3"/>'  alt="" class="asBigPic"/>
										</div>
										<div class="product-tab-list tab-pane fade" id="single-tab4">
											<img src='<s:property value="smartphone.pic4"/>'  alt="" class="asBigPic"/>
										</div>
									...
									<ul id="single-product-tab">
										<li class="active">
											<a href="#single-tab1"><img src='<s:property value="smartphone.pic1"/>'  alt=""  class="asMiniPic"/></a>
										</li>
										<li>
											<a href="#single-tab2"><img src='<s:property value="smartphone.pic2"/>'  alt="" class="asMiniPic"/></a>
										</li>
										<li>
											<a href="#single-tab3"><img src='<s:property value="smartphone.pic3"/>'  alt="" class="asMiniPic"/></a>
										</li>
										<li>
											<a href="#single-tab4"><img src='<s:property value="smartphone.pic4"/>'  alt="" class="asMiniPic"/></a>
										</li>
									</ul>
								</div>
								<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
									<div class="single-product-details res-pro-tb">
										<h1><s:property value="smartphone.marque"/> <s:property value="smartphone.model"/></h1>
										<div class="single-pro-price">
											<h3 style="color:white;">
												Prix : 
												<span class="single-regular">
													<s:if test="%{smartphone.prixMGA>=1000000}">
		                                    			<s:property value="%{smartphone.prixMGA/1000000}"/> 
				                                    	<s:if test="%{((smartphone.prixMGA - (smartphone.prixMGA/1000000)*1000000)/1000) == 0}">
				                               				000
				                               			</s:if>
				                               			<s:else>
				                               				<s:property value="%{(smartphone.prixMGA - (smartphone.prixMGA/1000000)*1000000)/1000}"/>
				                               			</s:else>
				                               			<s:if test="%{(((smartphone.prixMGA - (smartphone.prixMGA/1000000)*1000000)) - ((smartphone.prixMGA - (smartphone.prixMGA/1000000)*1000000)/1000)*1000) == 0}">
				                               				000
				                               			</s:if>
				                               			<s:else>
				                               				<s:property value="%{((smartphone.prixMGA - (smartphone.prixMGA/1000000)*1000000)) - ((smartphone.prixMGA - (smartphone.prixMGA/1000000)*1000000)/1000)*1000}"/>
				                               			</s:else>
		                                    		</s:if>
			                               			<s:elseif test="%{smartphone.prixMGA>=1000}">
				                               			<s:property value="%{smartphone.prixMGA/1000}"/> 
				                               			<s:if test="%{smartphone.prixMGA - ((smartphone.prixMGA/1000)*1000) == 0}">
				                               				000
				                               			</s:if>
				                               			<s:else>
				                               				<s:property value="%{smartphone.prixMGA - ((smartphone.prixMGA/1000)*1000)}"/>
				                               			</s:else>
				                               		</s:elseif>
			                                    	Ar
												</span>
										...
										<div class="single-pro-cn">
											<table class="asTable">
												<tr>
													<td><p> Système: </p></td>
													<td><p><s:property value="smartphone.systeme"/></p></td>
												</tr>
												<tr>
													<td><p>Version: </p></td>
													<td><p><s:property value="smartphone.version"/></p></td>
												</tr>
												<tr>
													<td><p>ROM: </p></td>
													<td><p> <s:property value="smartphone.rom"/> Go</p></td>
												</tr>
												<tr>
													<td><p>RAM: </p></td>
													<td><p> <s:property value="smartphone.ram"/> Go</p></td>
												</tr>
											</table>
											<table class="asTable">
												<tr>
													<td><p>Battérie: </p></td>
													<td><p> <s:property value="smartphone.capaciteBatt"/> mAh</p></td>
												</tr>
												<tr>
													<td><p>Caméra arrière: </p></td>
													<td><p> <s:property value="smartphone.backCam"/> mpx</p></td>
												</tr>
												<tr>
													<td><p>Caméra frontale: </p></td>
													<td><p> <s:property value="smartphone.frontCam"/> mpx</p></td>
												</tr>
												<tr>
													<td><p>Taille de l'écran: </p></td>
													<td><p> <s:property value="smartphone.pouce"/>"</p></td>
												</tr>
											</table>
										</div>
									</div>
